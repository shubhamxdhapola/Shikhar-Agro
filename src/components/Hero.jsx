      ...
      <div className="flex flex-col gap-8 md:gap-0 md:flex-row justify-center items-center px-4 md:px-6 lg:px-8 xl:px-10 2xl:px-14">
        <div className="md:w-1/2 md:pe-3 lg:pe-5">
          ...
          <div className="text-center flex-col gap-6 md:flex-row flex items-center md:text-left md:gap-2">
            <button className="px-4 py-2 text-sm lg:text-md lg:px-5 lg:py-3 text-center text-white rounded-full bg-[#4b8b3b] hover:bg-[#4b8b3b] duration-300  mr-3">
              Get Started
            ...
            <div className="flex items-center space-x-2 md:-space-x-2">
              {SOCIAL_HANDLES.map((item, index) => (
                ...
                >
                  <span>
                    {<item.icon className="duration-300 text-xl md:text-2xl mx-auto" />}
                  </span>
                </a>
              ))}
            </div>
